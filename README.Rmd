...
For a stable version of the package, including examples, to accompany the paper “Assessing treatment efficacy for interval censored endpoints using multistate semi-Markov models fit to multiple data streams”, please refer to: https://github.com/ammateja/MultistateModelsPaper. 
